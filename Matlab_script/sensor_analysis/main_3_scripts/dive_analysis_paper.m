...
for i = 1:big_num
	...
	turtle_dive_din.big_dive.homing(i).duration = turtle_big_time(i);
	...
	if dive_init < off_in_shore
		...
		turtle_dive_din.big_dive.homing(i).offinshore = "offshore";
	else
		turtle_dive.big_dive.homing(i).offinshore = "inshore";
		turtle_dive_din.big_dive.homing(i).offinshore = "inshore";
	end
	...
	turtle_dive_din.big_dive.homing(i).daynight = day_night;
...
for i = 1:sh_num
	...
	turtle_dive_din.shallow_dive.homing(i).duration = turtle_sh_time(i);
...
% 	set_sec		= second(sunset_hour(2));
	...
	if dive_init < off_in_shore
		...
		turtle_dive_din.shallow_dive.homing(i).offinshore = "offshore";
	else
		turtle_dive.shallow_dive.homing(i).offinshore = "inshore";
		turtle_dive_din.shallow_dive.homing(i).offinshore = "inshore";
	end
	...
	turtle_dive_din.shallow_dive.homing(i).daynight = day_night;
...
for i = 1:sub_num
	...
	turtle_dive_din.sub_surface.homing(i).duration = turtle_sub_time(i);
	...
	if dive_init < off_in_shore
		...
		turtle_dive_din.sub_surface.homing(i).offinshore = "offshore";
	else
		turtle_dive.sub_surface.homing(i).offinshore = "inshore";
		turtle_dive_din.sub_surface.homing(i).offinshore = "inshore";
	end
	...
	turtle_dive_din.sub_surface.homing(i).daynight = day_night;
